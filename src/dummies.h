...
void hand_C(i) int i; { ; }
void msg(s) char *s; { fprintf(stderr,s); }
void msg_1s(s,s1) char *s,*s1; { fprintf(stderr,s,s1); }
void msg_2s(s,s1,s2) char *s,*s1,*s2; { fprintf(stderr,s,s1,s2); }
void msg_1d(s,d) char *s; int d; { fprintf(stderr,s,d); }
