 ...
 */
#if !defined(linux) && !defined(alpha) && !defined(FreeBSD)
...
int conn_if P_ARGS(( REAL [], REAL [], REAL [], int ));
...
int histogram_if P_ARGS(( REAL [], REAL [], REAL [], int ));
...
void msg P_ARGS(( char * ));
void msg_1d P_ARGS(( char *, int ));
void msg_1f P_ARGS(( char *, double ));
void msg_1s P_ARGS(( char *, char * ));
void msg_2s P_ARGS(( char *, char *, char * ));
...
void points_if P_ARGS(( REAL [], REAL [], REAL [], int ));
...
int read_image P_ARGS(( char *, double, double, double, double ));
...
int meta_cursor P_ARGS(( int *, int * ));
...
#endif
void sm_shade P_ARGS(( int, REAL *, REAL *, int ));
int shade_hist P_ARGS(( int, REAL *, REAL *, int ));
...
int sunv_cursor P_ARGS(( int *, int * ));
...
int svgalib_cursor P_ARGS(( int *, int * ));
