...
c
	...
	call sm_limits(0.0,3.0,0.0,500.0)
	call sm_ticksize(-1.0,0.0,0.0,0.0)
	call sm_box(1,2,3,3)
        call sm_gflush
	call sm_alpha
	...
	call sm_erase
	call sm_limits(-1.0,22.0,0.0,500.0)
	call sm_ticksize(0.,0.,0.,0.)
	call sm_box(1,2,0,0)
	call sm_angle(45.0)
	...
	call sm_ltype(0)
	call sm_relocate(10.0,100.0)
	call sm_label('Hello ')
	call sm_dot
	call sm_draw(20.0,100.0)
